...
def get_stem_words(words, ignore_words):
    ...
    for word in words:
        ...
        if word not in ignore_words:
            w = stemmer.stem(word.lower())  #Makes word in all lower case and stems it (finds its root)
            stem_words.apprend(w) #adds the word to the list of stem words
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in data['intents']:
        ...
        for pattern in intent['patterns']:  
            ...
            pattern_word_tags_list.apprend(pattern_words, intent['tag'])
